"""Worker pool and multi-engine consensus evaluation for KnightVerse.

Holds the GPU worker pool that dispatches analysis requests to workers, plus
the EnsembleEvaluator, which runs a position through several engines
concurrently and aggregates their verdicts into a consensus.
"""
